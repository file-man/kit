...
public class StringUtils {
	...
	private static final List<String> splitByKey(String line, String key, int groupNum, int returnCount, boolean withTail) {
...
//		Log.print(src);
	...
	public static void fun(Function<String, String> f) {
		f.apply("a");
	}
}
